...
import { NotFoundError, ExternalServiceError, ValidationError } from "../errors";
...
export const createQuestion = async (
  ...
  try {
    ...
    let validatedData;
    try {
      validatedData = validateOrThrow(createQuestionSchema, {
        title,
        description,
        tags,
      ...
      throw new ValidationError("Invalid question data", zodError.errors);
    }
