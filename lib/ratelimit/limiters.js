...
export const limiterConfigs = {
  ...
  'quest-submit': { requests: 5, windowMs: MINUTE, description: 'Quest answer submission' },
  'ai-endpoint': { requests: 20, windowMs: MINUTE, description: 'AI API calls' },
  'youtube-api': { requests: 30, windowMs: MINUTE, description: 'YouTube searches' },
