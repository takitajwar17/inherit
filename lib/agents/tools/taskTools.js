  ...
  func: async ({ status, category, priority, limit }, config) => {
    try {
      ...
      if (!clerkId) {
        return JSON.stringify({
          success: false,
          message: "I was unable to retrieve your tasks. Please make sure you are logged in.",
        });
      }
  ...
  func: async ({ taskId, ...updates }, config) => {
    try {
      ...
      if (!clerkId) {
        return JSON.stringify({
          success: false,
          message: "I was unable to update the task. Please make sure you are logged in.",
        });
      }
  ...
  func: async ({ taskId }, config) => {
    try {
      ...
      if (!clerkId) {
        return JSON.stringify({
          success: false,
          message: "I was unable to delete the task. Please make sure you are logged in.",
        });
      }
  ...
  func: async ({ days, includeOverdue }, config) => {
    try {
      ...
      if (!clerkId) {
        return JSON.stringify({
          success: false,
          message: "I was unable to retrieve deadlines. Please make sure you are logged in.",
        });
      }
  ...
  func: async ({ taskId }, config) => {
    try {
      ...
      if (!clerkId) {
        return JSON.stringify({
          success: false,
          message: "I was unable to mark the task as complete. Please make sure you are logged in.",
        });
      }
