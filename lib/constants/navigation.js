...
import { TbLayoutDashboardFilled, TbCheckbox } from "react-icons/tb";
import { SiGoogleclassroom } from "react-icons/si";
import { FiMap, FiHelpCircle } from "react-icons/fi";
import { FaCodepen, FaComments, FaTrophy, FaYoutube } from "react-icons/fa";
...
export const SIDEBAR_NAVIGATION = [
  {
    ...
    links: [
      ...
      { href: "/tasks", icon: TbCheckbox, label: "Tasks" },
    ],
  },
  {
    section: "learning",
  ...
  },
  {
    ...
    isFirst: false,
    isLast: false,
    links: [{ href: "/quests", icon: FaTrophy, label: "Quests" }],
  },
  {
    section: "help",
    showBorder: false,
    ...
    links: [
      ...
      { href: "/watch-demo", icon: FaYoutube, label: "Watch Demo" },
    ],
  },
];
