...
export const MESSAGES = {
  ...
  greetings: {
    welcome: {
      en: "Hello! I'm your AI learning companion. How can I help you today?",
      bn: "হ্যালো! আমি আপনার এআই লার্নিং সহকারী। আজ আমি কিভাবে সাহায্য করতে পারি?"
    },
    warmWelcome: {
      en: "Hi there! Ready to learn something new?",
      bn: "হাই! নতুন কিছু শিখতে প্রস্তুত?"
    },
    general: {
